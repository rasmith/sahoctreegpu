...
inline __host__ __device__ float4 operator*(float4 a, float4 b ) {
  return make_float4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.z);
}
inline __host__ __device__ void operator*=(float4 &a, float4 b) {
  a.x *= b.x;
  a.y *= b.y;
...
// length
inline __host__ __device__ float length(float4 r) { return sqrtf(dot(r, r)); }
...
inline std::ostream& operator<<(std::ostream& os, const float4& x) {
  os << x.x << "  " << x.y << " " << x.z << " " << x.w;
  return os;
}

inline std::ostream& operator<<(std::ostream& os, const int4& x) {
  os << x.x << "  " << x.y << " " << x.z << " " << x.w;
  return os;
}

inline std::ostream& operator<<(std::ostream& os, const float3& x) {
  os << x.x << "  " << x.y << " " << x.z << " ";
  return os;
}

inline std::ostream& operator<<(std::ostream& os, const int3& x) {
  os << x.x << "  " << x.y << " " << x.z << " ";
  return os;
}
